...
public class TransportRegistry {
	...
	public Session createSession(String uriString, String params, ClientProxy proxy, RequestConfig requestConfig) {
		try {
			...
			return found.newSession(uri, params, proxy, requestConfig);
